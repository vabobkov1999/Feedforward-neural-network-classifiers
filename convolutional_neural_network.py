...
result_path = "dataset/saved_cnn"
plot_path = "../../Desktop/lr-6-opc-master/loss-accuracy-сnn.png"
...
# определим архитектуру нейронки с помощью Keras
model = Sequential()
#
